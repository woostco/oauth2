...
/// Obtains credentials using a [social grant][].
///
/// This mode of authorization uses the user's access token from a social service
/// to obtain an authentication token, which can then be stored. This is safer than
/// storing the social token directly, but it should be avoided if any
/// other authorization method is available, since it requires the user to
/// provide their social token to a third party (you).
///
